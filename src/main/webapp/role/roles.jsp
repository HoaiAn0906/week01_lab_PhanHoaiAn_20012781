...
<div class="container">
    <div class="d-flex align-items-center justify-content-between">
        <h1>Role List</h1>
        <button type="button" class="btn btn-success mt-1" onclick="window.location.href = 'control-servlet?action=add_role'">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <button type="button" class="btn btn-warning mr-2" onclick="window.location.href = 'control-servlet?action=edit_role&id=<%= role.getRoleId() %>'">
...
<script>
    function deleteRole(id) {
        if (confirm("Are you sure?")) {
            window.location.href = "control-servlet?action=delete_role&id=" + id;
        }
    }
</script>
</html>
